...
@Builder
@Entity
@Table(name = "farmafx_venta_detalles")
public class VentaDetalle {
    ...
    @Digits(integer = 10, fraction = 2, message = "El descuento debe tener como máximo 10 dígitos enteros y 2 decimales")
    @Column(nullable = false, precision = 12, scale = 2)
    ...
    @Column(nullable = false, precision = 12, scale = 2)
    private BigDecimal subtotalDetalleVenta;

    @NotNull(message = "La venta relacionada es obligatoria")
